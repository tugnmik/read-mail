...
const TRANSLATIONS = {
    vi: {
        ...
        'nav.verify': 'Xác thực Code',
        'verify.title': 'Trích xuất mã xác nhận',
        'verify.desc': 'Tự động trích xuất mã OTP, mã xác nhận và magic link từ các email mới nhất của bạn.',
        'verify.input.label': 'Thông tin tài khoản (email|password|refresh_token|client_id)',
        'verify.input.placeholder': 'email|password|refresh_token|client_id',
        'verify.sender.label': 'Lọc người gửi (tùy chọn)',
        'verify.sender.placeholder': 'noreply@github.com',
        'verify.limit.label': 'Kiểm tra gần nhất',
        'verify.btn': 'Trích xuất mã',
        'verify.results.title': 'Kết quả',
        'verify.found': 'Tìm thấy mã: {code}',
        'verify.notfound': 'Không tìm thấy mã xác nhận trong các email gần nhất',
        'verify.searching': 'Đang tìm kiếm...',
        'verify.from': 'Từ',
        'verify.subject': 'Tiêu đề',
        'verify.time': 'Nhận lúc',
        'verify.type': 'Loại',
        'verify.copied': 'Đã copy mã!',
        'verify.error.empty': 'Vui lòng nhập thông tin tài khoản',
        'alert.verify.empty': 'Vui lòng nhập thông tin tài khoản',
    },
    ...
    en: {
        ...
        'verify.title': 'Extract Verification Code',
        'verify.desc': 'Automatically extract OTP codes, verification codes, and magic links from your latest emails.',
        'verify.input.label': 'Account Info (email|password|refresh_token|client_id)',
        'verify.input.placeholder': 'email|password|refresh_token|client_id',
        'verify.sender.label': 'Sender Filter (optional)',
        'verify.sender.placeholder': 'noreply@github.com',
        'verify.limit.label': 'Check latest',
        'verify.btn': 'Extract Code',
        'verify.results.title': 'Results',
        'verify.found': 'Found code: {code}',
        'verify.notfound': 'No verification code found in the latest emails',
        'verify.searching': 'Searching...',
        'verify.from': 'From',
        'verify.subject': 'Subject',
        'verify.time': 'Received',
        'verify.type': 'Type',
        'verify.copied': 'Code copied!',
        'verify.error.empty': 'Please enter account information',
        'alert.verify.empty': 'Please enter account information',
    }
};
